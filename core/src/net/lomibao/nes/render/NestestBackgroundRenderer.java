...
/**
 * Platform-independent application that runs nestest.nes ROM and renders the background
 * tiles and nametables using the PPU rendering system. Can be used with any LibGDX backend.
 */
public class NestestBackgroundRenderer extends ApplicationAdapter {
    ...
    @Override
    public void create() {
        System.out.println("Starting NES Background Renderer with nestest.nes");
    ...
    /**
     * Loads the nestest.nes ROM file
     */
    private void loadROM() {
        try {
            cartridge = new Cartridge(
                Gdx.files.internal("roms/nestest.nes").read(),
                "nestest.nes"
            );
    ...
    public void render() {
        ...
        // Draw info text
        font.draw(batch, "NES Background Renderer - nestest.nes", 50, 550);
    ...
    /**
     * Converts NES color index to ARGB color using the NES master palette.
     */
